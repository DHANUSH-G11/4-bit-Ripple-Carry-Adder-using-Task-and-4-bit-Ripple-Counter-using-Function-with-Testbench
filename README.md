...
## OUTPUT
![image](https://github.com/user-attachments/assets/8f189b66-4b49-4dee-90d6-9ebc3beaefae)
...
// Function to calculate next state function [3:0] next_state; input [3:0] curr_state; 
...
// Reset the counter to 0 else Q <= next_state(Q); 
...
initial begin $monitor("Time = %0t | Reset = %b | Q = %b", $time, reset, Q); 
end
endmodule

## OUTPUT
![image](https://github.com/user-attachments/assets/9be0db91-4fe7-4817-90df-fc0e1ecb2ef4)
